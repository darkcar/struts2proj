<nav class="navbar navbar-expand navbar-dark bg-dark static-top">
	<a class="navbar-brand mr-1" href="${pageContext.request.contextPath}">CRM</a>
		...
		<li class="nav-item dropdown"><a class="nav-link dropdown-toggle"
			...
			<span>Customers</span>
				...
				<div class="dropdown-menu" aria-labelledby="pagesDropdown">
					...
					<a class="dropdown-item" href="${pageContext.request.contextPath }/customer/findAllCustomer">All Customers</a> 
					<a class="dropdown-item" href="${pageContext.request.contextPath }/customer/addUICustomer">Add Customer</a> 
				</div>
		</li>
	</ul>